...
const QString BITCOIN_IPC_PREFIX("secondscoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click secondscoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start secondscoin: click-to-pay handler");
    else
...
{
    // clicking on secondscoin: URLs creates FileOpen events on the Mac:
