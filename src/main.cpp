...
uint256 hashGenesisBlock("0x0000098795ee3837a8858ca83ac6b1425998821fd37e0c628f4f5a3e78367ba7");
static const unsigned int timeGenesisBlock = 1387700944;
...
const string strMessageMagic = "Secondscoin Signed Message:\n";
...
{
    //fixed 60 COIN every 60 seconds
...
*/
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xaaa0be79f6197d47f357044d82cd8082a0de963cea1cb2ba782c9a257169c1af"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SecondscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SecondscoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("SecondscoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("secondscoin-miner");
    ...
    try { loop {
        ...
        printf("Running SecondscoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("SecondscoinMiner terminated\n");
        throw;
    }
}
